...
public class PlayerControl : MonoBehaviour
{
    ...
    private void SlopeCheckVertical(Vector2 checkPos)
    {
        ...
        if (isOnSlope && movementInputDirection == 0.0f && canWalkOnSlope &&!isWallSliding)//경사 위에 있고 움직임이 없으며 max 앵글값보다 작은 값의 경사 위에 있을때.
    ...
    public void SetLayer(float x, float y, GameObject obj)
    {
        ...
        {
            case "RightWall":
                layerMask.transform.position = new Vector3(layerMask.transform.position.x + (x / 2), y, 0);
                layerMask.transform.localScale = new Vector3(layerMask.transform.localScale.x + FrameSizeX, layerMask.transform.localScale.y, 0);
                Debug.Log("X : " + x);
                ...
                RectColliderPos[0].transform.localScale = new Vector3(RectColliderPos[0].transform.localScale.x + FrameSizeX, RectColliderPos[0].transform.localScale.y, 0);
                //down상자 객체
                ...
                RectColliderPos[1].transform.localScale = new Vector3(RectColliderPos[1].transform.localScale.x + FrameSizeX, RectColliderPos[1].transform.localScale.y, 0);
                break;
            case "LeftWall":
            ...
            case "TopWall":
                ...
                layerMask.transform.localPosition = new Vector3(layerMask.transform.position.x, layerMask.transform.position.y + (y / 2), 0);
                //여기서 216 숫자의 의미 = 레이어마스크 scale의 1은 곧 프레임의 108픽셀이동이다 때문에 108의 두배인 216을 나눠줘야함.
                layerMask.transform.localScale = new Vector3(layerMask.transform.localScale.x, layerMask.transform.localScale.y + FrameSizeY, 0);
                ...
                RectColliderPos[2].transform.localScale = new Vector3(RectColliderPos[2].transform.localScale.x, RectColliderPos[2].transform.localScale.y + FrameSizeY, 0);
                //Left 상자 객체
                ...
                RectColliderPos[3].transform.localScale = new Vector3(RectColliderPos[3].transform.localScale.x, RectColliderPos[3].transform.localScale.y + FrameSizeY, 0);
                break;
            case "BottomWall":
            ...
            case "RightUp":
                ...
                layerMask.transform.localScale = new Vector3(layerMask.transform.localScale.x + FrameSizeX, layerMask.transform.localScale.y + FrameSizeY, 0);
    ...
    private void InitializeRect()
    {
        if (isWallOn && !isChangeWallOn && isMoveWall && !initial)//제일처음 초기의 상태
        {
            ...
            RectRightUp.Set(transform.position.x + ((1920 / 10) * LightRadius.x), transform.position.y + ((1080 / 10) * LightRadius.y), 0);
            RectRightDown.Set(transform.position.x + ((1920 / 10) * LightRadius.x), transform.position.y - ((1080 / 10) * LightRadius.y), 0);
            RectLeftUp.Set(transform.position.x - ((1920 / 10) * LightRadius.x), transform.position.y + ((1080 / 10) * LightRadius.y), 0);
            RectLeftDown.Set(transform.position.x - ((1920 / 10) * LightRadius.x), transform.position.y - ((1080 / 10) * LightRadius.y), 0);
            for (int i = 0; i < 4; i++)
            {
                RectColliderPos[i].transform.localScale = new Vector3(2, 2, 0);
            }
        }
